...
It focuses on low-channel 2D convolutions (from 8 to 64).
...
- Modify `main.cu` to add meaningful metrics. Although in the end running time will be the most important. Focus on square resolutions from 1024x1024 64 channels. This file will output the latest kernel time in the last 
